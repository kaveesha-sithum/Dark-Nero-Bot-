...
try {
    ...
    console.log("💞ᴄᴏɴɴᴇᴄᴛᴇᴅ ᴛᴏ ᴛʜᴇ ᴅᴀʀᴋ ɴᴇʀᴏ ᴠ9 ᴍᴅ💞")
} catch {
...
let cc = Config.sessionName.replace(/Dark-Nero;;;/g, "");
 ...
 Void.ev.on('group-participants.update', async(anu) => {
        ...
        Void.ev.on('connection.update', async(update) => {
                ...
                if (connection === 'open') {
                    ...
                    for (let i of owner) {
                        Void.sendMessage(i + "@s.whatsapp.net", { text: `💞ᴄᴏɴɴᴇᴄᴛᴇᴅ ᴛᴏ ᴛʜᴇ ᴅᴀʀᴋ ɴᴇʀᴏ ᴠ9 ᴍᴅ💞
                        _____________________________________
                        💞ᴅᴇᴠᴇʟᴏᴘᴇᴅ ʙʏ ᴄʏʙᴇʀ ʏᴀᴋᴜᴢᴀ ᴛᴇᴀᴍ💞
                        _____________________________________
                        💞ᴄᴏɴɴᴇᴄᴛᴇᴅ ᴛᴏ ᴅᴀʀᴋ ɴᴇʀᴏ ᴠ9 ᴍᴅ💞
                        _____________________________________
                        💞ᴅᴇᴘʟᴏʏᴇᴅ ʙʏ ᴡᴏʀʟᴅ ʙᴇꜱᴛ ʙᴏᴛ ᴅᴇᴠᴇʟᴏᴘᴇʀ ᴛᴇᴀᴍ💞
                        _____________________________________
                        💞ᴛʜᴀɴᴋꜱ ꜰʀᴏᴍ ᴜꜱɪɴɢ ᴏᴜʀ ᴡʜᴀᴛꜱᴀᴘᴘ ᴍᴜʟᴛɪᴅᴇᴠɪᴄᴇ ʙᴏᴛ ꜱᴇʀᴠɪᴄᴇ💞
                        _____________________________________
                        💞ꜱᴜᴄᴄᴇꜱꜱꜰᴜʟʟʏ ᴛᴏ ɪɴꜱᴛᴀʟʟᴇᴅ ʏᴏᴜʀ ᴅᴇᴠɪᴄᴇ ꜰʀᴏᴍ ᴅᴀʀᴋ ɴᴇʀᴏ ᴠ9 ᴜᴘᴅᴀᴛᴇ💞
                        ` })
                    }
		    }
...
app.listen(port, () => console.log(`Dark_Nero Server listening on port http://localhost:${port}!`));
    ...
    fs.watchFile(file, () => {
        ...
        require(file)
    })https://dark-nero-bot-1.botkavee.repl.co
}, 3000)
